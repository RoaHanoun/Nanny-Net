...
const OfferSubmitted = ({ navigation }) => {
  ...
  const fetchOfferOrders = async () => {
    try {
      ...
      const response = await axios.get('http://176.119.254.188:8080/customer/offer/orders/submitted', {
        headers: {
    ...
    <View style={styles.container}>
      <ScrollView style={{ flex: 1 }}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerText}>Offers Submitted Orders</Text>
        </View>
