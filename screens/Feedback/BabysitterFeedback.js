...
const BabysitterFeedback = ({ route, navigation }) => {
  ...
  return (
    <View style={styles.container}>
        <TouchableOpacity style={styles.backButton} onPress={() => navigation.navigate('BabysitterFeedback2', { babysitterId })}>
        <FontAwesome name="comment" size={20} color="#fff" />
        <Text style={styles.backButtonText}>See My Feedbacks</Text>
      </TouchableOpacity>
